...
from .views import (
    ...
    buy_multiple_tickets, set_manual_raffle_winner, set_manual_multiple_winners, manage_printable_cards, 
...
urlpatterns = [
    ...
    path('raffle/<int:raffle_id>/set-manual-multiple-winners/', views.set_manual_multiple_winners, name='set_manual_multiple_winners'),
